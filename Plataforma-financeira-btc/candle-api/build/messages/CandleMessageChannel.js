    ...
    CandleMessageChannel.prototype.consumeMessages = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._createMessageChannel()]; //cria primeiro a messagechannel e depois consome
                    case 1:
                        _a.sent(); //cria primeiro a messagechannel e depois consome
                        if (this._channel) {
